...
description: "ヨーロッパ新婚旅行で訪れたブダペスト3泊4日の前編。リスト・フェレンツ空港からのアクセス、BudapestGOアプリ設定、ドナウ川夜景、ブダ城、中央市場、マンガリッツァ豚レストランMenzaなど観光ルートを実体験で紹介。"
tags: ["ブダペスト観光", "BudapestGO", "マンガリッツァ豚", "中央市場", "ブダ城", "ヨーロッパ新婚旅行", "ハンガリー旅行", "個人手配"]
...
archives: ["2024年10月"]
---
ブダペスト3泊4日の観光前編では、空港から市内アクセス、BudapestGOアプリの設定方法、ブダ城・中央市場・国会議事堂などの観光ルート、そして名物料理マンガリッツァ豚までを紹介します。

個人手配旅行の実体験をもとに、交通・食事・宿泊情報をまとめました。
...
## 1日目：空港から市内へ移動【リスト・フェレンツ国際空港アクセス】

{{< custom-figure src="IMG_4814-768x1024.jpg" title="" Fit="1280x1280 webp q90" >}}  
...
この後は100Eバスでホテルへと移動しますが、**切符を購入するときにトラブル発生**！

{{< custom-figure src="IMG_4815-768x1024.jpg" title="" Fit="1280x1280 webp q90" >}} 
...
事前準備編でも書きましたが、**クレジットカード会社への海外利用通知は行った方が良いです！**

{{< blog-card "https://arukayies.com/diy/travel/europe-honeymoon-preparation#toc22" >}}

それでも決済エラーとなった場合に有効だった解決方法は、 **3Dセキュア設定を一時的に無効にする** でした！

BudapestGOというアプリで決済を行う時は **3Dセキュア設定を無効にする** ことで使えるようになり、

この後のルーブル美術館の予約では **Dセキュア設定を有効に戻す** 必要がありました！

{{< custom-figure src="IMG_4816-768x1024.jpg" title="" Fit="1280x1280 webp q90" >}} 
...
昼前にロンドン食べた「[イングリッシュブレックファースト](https://arukayies.com/diy/travel/europe-honeymoon-london-tourism#toc15)」がなかなか重かったので、軽めの夕食を買いに近くのスーパーへ。

{{< blog-card "https://arukayies.com/diy/travel/europe-honeymoon-london-tourism#toc15" >}}
...
パンは値札の番号か商品名を入力する必要があったので、 **どれを袋に入れたか覚えておく必要がありました！**
  
1. パンをカテゴリ or 番号から選びタッチする
1. 個数を入力しタッチする
1. シールを印刷する
...
{{< custom-figure src="IMG_4837-1024x768.jpg" title="" Fit="1280x1280 webp q90" >}}  

### BudapestGOアプリの使い方と3Dセキュアエラー解決法
...
そのまま連携すると **日本語の住所が反映されるので、英語表記に直す必要** がありました。
...
エラーメッセージやメールを見ると「 **3ds process error** 」という文字がありました。

3Dセキュアのことを指してると気づき、 **有効だった設定を無効に切り替えることで支払い情報を追加することができました。**
...
① **アカウント情報には「日本語」を含めないようにする！**

設定でエラーとなります。

エラーも英語でどこが間違っているかは教えてくれません。

② **クレジットカードの3Dセキュアは無効にする**

カード会社によって変わるかもしれませんが、 **楽天カードでは無効にすることで決済できるようになりました。**

### 8時：ホテルで新鮮な食材の朝食

{{< custom-figure src="IMG_4838-1024x768.jpg" title="" Fit="1280x1280 webp q90" >}}  

朝食付きなので朝はホテルで食べました。

サラダやフルーツとどれも美味しく、特に昨晩から食べた「**サラミ**」が美味しいのが思い出です。

### ブダ城から眺める絶景とドナウ川の街歩きルート
...
市場の2階レストランで、定番料理のグヤーシュスープと粗挽きソーセージを注文。

地元客に混ざって食べるランチは、旅行者にも人気の体験です。合計：7300Ft（2,978円）

お店はこちら

{{< blog-card "https://maps.app.goo.gl/yriBVfzP2FFsJKwVA" >}}

### ハンガリー国立博物館を外から楽しむ観光ポイント
...
### カフェ巡り：ドボシュトルタが味わえる「Stephen Confectionery」
...
**ドナウ川の氾濫警報が出ていて、氾濫するギリギリの状態**でした。[話題](https://www.hungary-travel-living.org/natural-disaster-hungary/)にもなってました。

ルートはこちら

{{< blog-card "https://maps.app.goo.gl/zGuD8bXGVkeR5aP29" >}}

### ハンガリー名物マンガリッツァ豚を堪能できるレストラン「Menza」レビュー
...
{{< custom-figure src="IMG_4865-1024x768.jpg" title="" Fit="1280x1280 webp q90" >}}  
