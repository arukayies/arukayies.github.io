...
---
## <span id="toc1">私たちについて</span> {.wp-block-heading}

私たちのサイトアドレスは <https://arukayies.com>です。

## <span id="toc2">このサイトが収集する個人データと収集の理由</span> {.wp-block-heading}

### <span id="toc3">個人情報の管理</span> {.wp-block-heading}

個人情報を取り扱うにあたっては、「個人情報の保護に関する法律」をはじめとする個人情報の保護に関する法令、ガイドラインおよび本プライバシーポリシーを遵守いたします。

### <span id="toc4">個人情報の利用目的</span> {.wp-block-heading}

当サイトでは、訪問者様からのお問い合わせ時に、お名前、e-mailアドレス、電話番号等の個人情報をご登録いただく場合がございますが、これらの個人情報はご提供いただく際の目的以外では利用いたしません。

### <span id="toc5">個人情報の第三者への開示</span> {.wp-block-heading}
...
### <span id="toc6">当サイトが使用しているアクセス解析ツールについて</span> {.wp-block-heading}
...
### <span id="toc7">当サイトの広告について</span> {.wp-block-heading}
...
### <span id="toc10">コメント</span> {.wp-block-heading}
...
### <span id="toc12">Cookie</span> {.wp-block-heading}
...
### <span id="toc13">他サイトからの埋め込みコンテンツ</span> {.wp-block-heading}
...
## <span id="toc14">データを保存する期間</span> {.wp-block-heading}
...
## <span id="toc15">データに対するあなたの権利</span> {.wp-block-heading}
